        ...
        new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                ...
                if (reservation != null) {
                    ...
                    sb.append("Flight code: ").append(reservation.getFlight().getCode()).append("\n");
                    ...
                    sb.append("Place: ").append(reservation.getPlace().getSeatLetter() + reservation.getPlace().getSeatNumber()).append("\n");
